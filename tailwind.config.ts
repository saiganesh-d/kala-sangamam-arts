  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Temple Inspired Sacred Colors
        "sacred-maroon": "hsl(var(--sacred-maroon))",
        ...
        "divine-red": "hsl(var(--divine-red))",
        "sacred-bronze": "hsl(var(--sacred-bronze))",
        "temple-amber": "hsl(var(--temple-amber))",
      },
      backgroundImage: {
        ...
        "gradient-sanctum": "var(--gradient-sanctum)",
      },
      boxShadow: {
